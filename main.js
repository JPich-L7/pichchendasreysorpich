...
const completedTask = document.querySelector('#complete-list .complete-title > .badge');
...
allTasks.addEventListener('click', function(e) {
	...
	if (e.target.classList.contains("markComplete")) {
		...
		completedTask.textContent = allCompleteList.childElementCount;
	}
...
const hideListBtn = document.querySelector(".complete-title > span.hide-list");
...
const expandSpan = document.querySelector("#complete-list > .complete-title span.material-icons");
